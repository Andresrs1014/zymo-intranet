      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {badge !== undefined && badge > 0 && (
            <span className="inline-flex items-center justify-center rounded-full bg-brand-yellow px-2 py-0.5 text-xs font-bold text-brand-blue min-w-[1.25rem]">
              {badge}
            </span>
          )}
        </div>
