...
function RoleFormModal({ role, onSubmit, onClose, isLoading, error }: RoleFormModalProps) {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    if (isEdit) {
      onSubmit({ label, description: description || undefined, app_permissions: permissions })
    } else {
      onSubmit({ name, label, description: description || undefined, app_permissions: permissions })
    }
  }
