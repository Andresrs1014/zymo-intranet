...
def crear_oc_vinculada_core(
    ...
    oc = SolicitudOC(
        ...
        tipo_solicitud="servicio" if mnt.modalidad == "externo" else "compra",
        modalidad_mantenimiento=mnt.modalidad if mnt.modalidad == "externo" else None,
        clasificacion_mantenimiento=mnt.clasificacion if mnt.modalidad == "externo" else None,
        tipo_mantenimiento=mnt.tipo_mantenimiento if mnt.modalidad == "externo" else None,
